...
LIBTCCAPI void (*tcc_set_error_func)(TCCState *s, void *error_opaque, void (*error_func)(void *opaque, const char *msg)) = NULL;

/* set options as from command line (multiple supported) */
LIBTCCAPI int (*tcc_set_options)(TCCState *s, const char *str) = NULL;
