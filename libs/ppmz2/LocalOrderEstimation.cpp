...
EXPORT int Ppmz2::LocalOrderEstimation::ChooseOrder(Ppmz2::LocalOrderEstimation::LOEType loeType, Ppmz2::Context ** contexts, unsigned long cntx, int maxOrder, Ppmz2::Exclude* exc, Ppmz2::See* see, bool useFull)
{
    int rating;
